...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "skk-macs" '("cancel-undo-boundary" "event-to-character" "next-command-event" "skk-" "string-to-int-list")))
